...
import com.crud.restfull.user.common.ApiResponse;
...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<String>> addUser(@RequestBody User user) {
        ...
        UserInPort.parameterInPort command = new UserInPort.parameterInPort(user.getName(), user.getEmail(), user.getPassword(), user.getPhones());
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<String>> updateUser(@PathVariable Long id, @RequestBody User userUpdate) {
