...
public class BasicHexagonalTest {
    ...
    void basicTest() {
        ...
        final var hexagon = new ClassFileImporter().importPackages("com.crud");
        layeredArchitecture()
                ...
                .layer("Web").definedBy("..infrastructure.adapters.ports.in..")
                .layer("Services").definedBy("..application.services..")
                .layer("Adapters").definedBy("..infrastructure.adapters.ports.out..")
